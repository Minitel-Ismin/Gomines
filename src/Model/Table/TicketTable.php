...
class TicketTable extends Table {
	...
	public function validationDefault(Validator $validator) {
		...
		$validator->allowEmpty ( 'theme' );
		
		
		$validator->requirePresence ( 'asker', 'create' )->notEmpty ( 'asker' );
		
		$validator->requirePresence ( 'theme', 'create' )->notEmpty ( 'theme' );
		
		$validator->requirePresence ( 'question', 'create' )->notEmpty ( 'theme' );
